...
public class CrawlDBScanner extends Configured implements Tool,
	...
	private void scan(Path crawlDb, Path outputPath, String regex,
			String status, boolean text) throws IOException {
