...
public class NGramProfile {
  ...
  final static int ABSOLUTE_MAX_NGRAM_LENGTH = 8;
    
  /** The default min length of ngram */
  final static int DEFAULT_MIN_NGRAM_LENGTH = 5;

  /** The default max length of ngram */
  final static int DEFAULT_MAX_NGRAM_LENGTH = 5;
  ...
  public void add(Token t) {
    add(new StringBuffer().append(SEPARATOR)
                          .append(new String(t.buffer(), 0, t.length()))
                          .append(SEPARATOR));
  }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      if (LOG.isErrorEnabled()) { LOG.error("Caught an exception:" + e); }
    }
  }
