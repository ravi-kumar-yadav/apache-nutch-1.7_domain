  ...
  public ParseResult getParse(Content content) {
	...
	try {
		...
		LanguageIdentifier indianLangIdentifier = LanguageIdentifier
				.getInstance(conf);
		Language language = indianLangIdentifier.getLanguage(
				content.getUrl(), text);
		...
		DomainIdentifier domainIdentifier = DomainIdentifier
				.getInstance(conf);
		Domain domain = domainIdentifier.getDomain(content.getUrl(), text,
				language);
		...
		// domainStr = "misc";
		System.out.println("unsupportedDomain");
		//FIXME put score update code here
